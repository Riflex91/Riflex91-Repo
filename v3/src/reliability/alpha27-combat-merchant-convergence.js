  ...
  status() {
    ...
    return {
      ...
      policies: {
        ...
        gearGoalRequiredForNormalProgressionUpgrade: true,
        productionRecipeDemandMayAuthorizeExactUpgrade: true,
        productionRecipeDemandMustMatchExactIdentity: true,
        productionRecipeDemandCannotOverrideFarmerProtection: true,
