/* Adventure Land • AiO Bot 2.14.38 | 2026-09-11
...
(function () {
  ...
  var defaults = {
    ...
    merchantBuffRequestRepeatSeconds: 60, merchantBuffConfirmSeconds: 15,
    groupBuffAssignments: {}, merchantItemPermissions: {},
  ...
  function v21423BuffServiceTick(){
    ...
    var target=localPlayer(q.name),d=GD.skills&&GD.skills[q.skill]||{},range=Math.max(0,Number(d.range)||0);
