/* Adventure Land • AiO Bot 2.15.0 | 2026-09-10
...
(function () {
  ...
  ,
    'merchant-bank-warehouse','merchant-active-discovery','merchant-gathering','merchant-discovery-safety','brain-world-model','brain-safe-experiments','brain-goal-planner','brain-explainability','brain-keyword-learning','dashboard-game-sprites'
  ];
  ...
  toolDefs=function(){return [
    ...
    ['brain','spark',(C.language==='de'?'Bot-Gehirn':'Bot Brain'),'Weltwissen · Discovery · Experimente · Planner · Selbstprüfung'],['merchant','flask',T('merchant'),C.language==='de'?'Merchant-Verhalten und Elixiere':'Merchant behavior and elixirs'],['stand','store',T('stand'),'Explicit opt-in and precise limits'],
