/* Adventure Land • AiO Bot 2.13.0 | 2026-09-10
...
(function () {
  ...
  var CSS='\
    ...
    input,textarea,select{pointer-events:auto!important;user-select:text!important;-webkit-user-select:text!important}.mainbox.collapsed .maincontent,.mainbox.collapsed .statusline{display:none!important}.mainbox.collapsed{height:auto!important}.planlist{display:grid;gap:6px;margin-top:8px}.planstep{display:grid;grid-template-columns:24px 1fr;gap:8px;align-items:start;padding:7px;border:1px solid var(--border);border-radius:8px;background:var(--surface)}.planstep.current{border-color:var(--accent)}.planstep b{color:var(--accent)}.bar.mp i{background:#3b82f6!important}.bar.hp i{background:#e5484d!important}.dbstats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.dbstats>div{padding:7px;background:var(--surface);border-radius:7px;text-align:center}.dbstats b{display:block;font-size:14px}.material{color:var(--accent);font-weight:700}\
