...
test("PR20.9 manual development override advances roadmap without inventing Craft evidence",()=>{
  ...
  assert.equal(roadmap.pr21.status,"PR22_COORDINATION_PRODUCTIVE_AUTHORITY_DEFAULT_OFF_APPLY_BOUNDARY_PREPARED_WAITING_FOR_PR21_EXECUTION");
  ...
  assert.equal(roadmap.pr21.repositoryStageStatePostExecutionFinalizationBoundary.status,"PREPARED_POST_EXECUTION_FINALIZATION_RECORD_ONLY");
  assert.equal(roadmap.pr21.repositoryStageStatePostExecutionFinalizationBoundary.executionPerformed,false);
  assert.equal(roadmap.pr21.repositoryStageStatePostExecutionFinalizationBoundary.pr22DevelopmentHandoffPreparedOnVerifiedExecution,true);
  assert.equal(roadmap.pr21.repositoryStageStatePostExecutionFinalizationBoundary.pr22ProductiveHandoffPrepared,false);
  assert.equal(roadmap.pr22.status,"BLOCKED_BY_PR21");
  assert.equal(roadmap.pr22.developmentHandoffBoundary.status,"PREPARED_PR22_DEVELOPMENT_HANDOFF_RECORD_ONLY");
  assert.equal(roadmap.pr22.developmentHandoffBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.developmentHandoffBoundary.handoffExecuted,false);
  assert.equal(roadmap.pr22.developmentHandoffBoundary.sendCmAuthority,false);
  assert.equal(roadmap.pr22.developmentHandoffBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(roadmap.pr22.coordinationDevelopmentPreflightBoundary.status,"PREPARED_PR22_COORDINATION_DEVELOPMENT_PREFLIGHT_NO_WRITE");
  assert.equal(roadmap.pr22.coordinationDevelopmentPreflightBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationDevelopmentPreflightBoundary.preflightExecuted,false);
  assert.equal(roadmap.pr22.coordinationDevelopmentPreflightBoundary.externalRuntimeStartAuthorized,false);
  ...
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceAdmissionBoundary.status,"PREPARED_PR22_COORDINATION_PRODUCTIVE_EVIDENCE_ADMISSION_NO_EXECUTION");
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceAdmissionBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceAdmissionBoundary.admissionExecuted,false);
  ...
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.status,"PREPARED_ONE_SHOT_PR22_COORDINATION_PRODUCTIVE_EVIDENCE_EXECUTION");
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.executionPerformed,false);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.sendCmCallsObserved,0);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.productiveEvidenceSatisfied,false);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.sendCmAuthority,false);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceRatificationBoundary.status,"PREPARED_EXPLICIT_PR22_PRODUCTIVE_EVIDENCE_RATIFICATION_RECORD_ONLY");
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceRatificationBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationProductiveEvidenceRatificationBoundary.ratificationExecuted,false);
  ...
  assert.equal(roadmap.pr22.coordinationProductiveDefaultOffGateApplyBoundary.status,"PREPARED_PR22_PRODUCTIVE_DEFAULT_OFF_GATE_APPLY_NO_EXECUTION");
  assert.equal(roadmap.pr22.coordinationProductiveDefaultOffGateApplyBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationProductiveDefaultOffGateApplyBoundary.applyAdapterInstalled,false);
  assert.equal(roadmap.pr22.coordinationProductiveDefaultOffGateApplyBoundary.executionEnabled,false);
  assert.equal(roadmap.pr22.coordinationProductiveDefaultOffGateApplyBoundary.gateMutationPerformed,false);
  assert.equal(roadmap.pr22.coordinationProductiveDefaultOffGateApplyBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.status,"PREPARED_EXPLICIT_PR22_PRODUCTIVE_GATE_APPLY_ONE_SHOT_AUTHORIZATION_NO_EXECUTION");
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.gateApplyExecutionAuthorizationIssued,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.executionEnabled,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.executionPerformed,false);
  ...
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.status,"PREPARED_PR22_PRODUCTIVE_GATE_APPLY_POST_SETTLEMENT_PROPOSAL_ONLY");
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.authorityApplyAdapterInstalled,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.authorityApplyExecutionEnabled,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.additionalGateMutationPerformed,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.productiveAuthorityIssued,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.sendCmAuthority,false);
  assert.equal(roadmap.pr22.coordinationProductiveGateApplyPostSettlementBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(roadmap.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.status,"PREPARED_PR22_PRODUCTIVE_AUTHORITY_DEFAULT_OFF_APPLY_NO_EXECUTION");
  assert.equal(roadmap.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.currentBlockedByPr21Execution,true);
  assert.equal(roadmap.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.authorityApplyAdapterInstalled,false);
  assert.equal(roadmap.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.executionEnabled,false);
  assert.equal(roadmap.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.productiveAuthorityIssued,false);
  assert.equal(roadmap.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.sendCmAuthority,false);
  assert.equal(roadmap.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.pr22ProductiveAuthorityIssued,false);
...
test("Merchant and PR21 contracts accept only the development override, never runtime authority",()=>{
  ...
  assert.equal(
    ...
    "PR22_COORDINATION_PRODUCTIVE_AUTHORITY_DEFAULT_OFF_APPLY_BOUNDARY_PREPARED_WAITING_FOR_PR21_EXECUTION",
  );
  ...
  assert.equal(foundations.stages.pr21.repositoryStageStatePostExecutionFinalizationBoundary.status,"PREPARED_POST_EXECUTION_FINALIZATION_RECORD_ONLY");
  assert.equal(foundations.stages.pr21.repositoryStageStatePostExecutionFinalizationBoundary.executionPerformed,false);
  assert.equal(foundations.stages.pr21.repositoryStageStatePostExecutionFinalizationBoundary.pr22DevelopmentHandoffPreparedOnVerifiedExecution,true);
  assert.equal(foundations.stages.pr21.repositoryStageStatePostExecutionFinalizationBoundary.pr22ProductiveHandoffPrepared,false);
  assert.equal(foundations.stages.pr22.developmentHandoffBoundary.status,"PREPARED_PR22_DEVELOPMENT_HANDOFF_RECORD_ONLY");
  assert.equal(foundations.stages.pr22.developmentHandoffBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.developmentHandoffBoundary.handoffExecuted,false);
  assert.equal(foundations.stages.pr22.developmentHandoffBoundary.sendCmAuthority,false);
  assert.equal(foundations.stages.pr22.developmentHandoffBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(foundations.stages.pr22.coordinationDevelopmentPreflightBoundary.status,"PREPARED_PR22_COORDINATION_DEVELOPMENT_PREFLIGHT_NO_WRITE");
  assert.equal(foundations.stages.pr22.coordinationDevelopmentPreflightBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationDevelopmentPreflightBoundary.preflightExecuted,false);
  assert.equal(foundations.stages.pr22.coordinationDevelopmentPreflightBoundary.externalRuntimeStartAuthorized,false);
  ...
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceAdmissionBoundary.status,"PREPARED_PR22_COORDINATION_PRODUCTIVE_EVIDENCE_ADMISSION_NO_EXECUTION");
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceAdmissionBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceAdmissionBoundary.admissionExecuted,false);
  ...
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.status,"PREPARED_ONE_SHOT_PR22_COORDINATION_PRODUCTIVE_EVIDENCE_EXECUTION");
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.executionPerformed,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.sendCmCallsObserved,0);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.productiveEvidenceSatisfied,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.sendCmAuthority,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceOneShotExecutionBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceRatificationBoundary.status,"PREPARED_EXPLICIT_PR22_PRODUCTIVE_EVIDENCE_RATIFICATION_RECORD_ONLY");
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceRatificationBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationProductiveEvidenceRatificationBoundary.ratificationExecuted,false);
  ...
  assert.equal(foundations.stages.pr22.coordinationProductiveDefaultOffGateApplyBoundary.status,"PREPARED_PR22_PRODUCTIVE_DEFAULT_OFF_GATE_APPLY_NO_EXECUTION");
  assert.equal(foundations.stages.pr22.coordinationProductiveDefaultOffGateApplyBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationProductiveDefaultOffGateApplyBoundary.applyAdapterInstalled,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveDefaultOffGateApplyBoundary.executionEnabled,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveDefaultOffGateApplyBoundary.gateMutationPerformed,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveDefaultOffGateApplyBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.status,"PREPARED_EXPLICIT_PR22_PRODUCTIVE_GATE_APPLY_ONE_SHOT_AUTHORIZATION_NO_EXECUTION");
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.gateApplyExecutionAuthorizationIssued,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.executionEnabled,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyExecutionAuthorizationBoundary.executionPerformed,false);
  ...
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.status,"PREPARED_PR22_PRODUCTIVE_GATE_APPLY_POST_SETTLEMENT_PROPOSAL_ONLY");
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.authorityApplyAdapterInstalled,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.authorityApplyExecutionEnabled,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.additionalGateMutationPerformed,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.productiveAuthorityIssued,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.sendCmAuthority,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveGateApplyPostSettlementBoundary.pr22ProductiveAuthorityIssued,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.status,"PREPARED_PR22_PRODUCTIVE_AUTHORITY_DEFAULT_OFF_APPLY_NO_EXECUTION");
  assert.equal(foundations.stages.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.currentBlockedByPr21Execution,true);
  assert.equal(foundations.stages.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.authorityApplyAdapterInstalled,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.executionEnabled,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.productiveAuthorityIssued,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.sendCmAuthority,false);
  assert.equal(foundations.stages.pr22.coordinationProductiveAuthorityDefaultOffApplyBoundary.pr22ProductiveAuthorityIssued,false);
