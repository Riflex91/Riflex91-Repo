...
test("PR20.9 manual development override advances roadmap without inventing Craft evidence",()=>{
  ...
  assert.equal(roadmap.pr21.status,"PR22_COORDINATION_PRODUCTIVE_DEFAULT_OFF_GATE_APPLY_BOUNDARY_PREPARED_WAITING_FOR_PR21_EXECUTION");
...
test("Merchant and PR21 contracts accept only the development override, never runtime authority",()=>{
  ...
  assert.equal(
    ...
    "PR22_COORDINATION_PRODUCTIVE_DEFAULT_OFF_GATE_APPLY_BOUNDARY_PREPARED_WAITING_FOR_PR21_EXECUTION",
  );
