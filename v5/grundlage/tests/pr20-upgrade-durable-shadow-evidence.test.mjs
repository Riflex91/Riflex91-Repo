...
test("current recovery hardening evidence stays immutable while the manifest advances to anniversarygift Exchange service mount", () => {
  ...
  assert.equal(manifest.packagePath,"v5/werkzeuge/pr20-8-exchange-anniversarygift-live-5m.js");
