...
test("active manifest has advanced to the anniversarygift Exchange service mount",()=>{
  ...
  assert.equal(manifest.sourceCommit,
    "9e1066800aaf92cccaaf088c846df1057e4a8eaa");
  assert.equal(manifest.packagePath,
    "v5/werkzeuge/pr20-8-exchange-anniversarygift-autonomy-route-shadow-no-write-v1-0-1.js");
  assert.equal(manifest.packageSha256,
    "9a459d62653f0420c89343196ce2469611e01d110ebab2d2717cb54bb7596604");
