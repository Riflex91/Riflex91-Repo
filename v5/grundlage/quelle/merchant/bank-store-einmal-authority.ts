...
export const BANK_STORE_ACTION_CONTRACT_ID = "AL-ACTION-BANK-WITHDRAW";
export const BANK_STORE_RECOVERY_CONTRACT_ID = "AL-RECOVERY-BANK-WITHDRAW";
export const BANK_STORE_VERIFIER_ID = "AL-VERIFIER-BANK-WITHDRAW";
