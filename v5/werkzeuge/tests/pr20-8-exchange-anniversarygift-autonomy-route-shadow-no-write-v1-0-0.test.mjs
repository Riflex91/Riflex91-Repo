...
const source=fs.readFileSync(
  "werkzeuge/pr20-8-exchange-anniversarygift-autonomy-route-shadow-no-write-v1-0-0.js",
  "utf8",
);
...
async function run(options={}){
  ...
  vm.runInContext(source,ctx.box,{
    filename:"pr20-8-exchange-anniversarygift-autonomy-route-shadow-no-write-v1-0-0.js",
  });
