...
test("PR20.6 updater recovery bootstrap v4 is terminal, no-write and installs updater 1.0.6", async () => {
  assert.ok(source.includes("pr20-6-native-updater-recovery-bootstrap-v4"));
  ...
  assert.equal(state.testId, "pr20-6-native-updater-recovery-bootstrap-v4");
