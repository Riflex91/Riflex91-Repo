...
test("PR20.6 updater recovery bootstrap is terminal, no-write and installs updater 1.0.3", async () => {
  ...
  assert.equal(sandbox.V5AutonomousTestIngameUpdater.version, "1.0.3");
