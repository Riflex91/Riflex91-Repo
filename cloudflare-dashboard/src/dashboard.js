...
.automation-viewbar{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 12px;padding:9px 11px;border:1px solid #3c4d55;background:#0c1114}
.automation-viewbar>div:first-child{display:flex;align-items:baseline;gap:10px;min-width:0}.automation-viewbar b{font-size:11px;letter-spacing:.06em;text-transform:uppercase}.automation-view-toggle{display:flex;gap:1px;flex:0 0 auto;background:#3c4d55;border:1px solid #3c4d55}.automation-view-toggle button{border:0;border-radius:0;background:#172126;color:#9aabb0;padding:7px 11px;cursor:pointer;font:700 10px/1.2 ui-monospace,SFMono-Regular,Consolas,monospace}.automation-view-toggle button[aria-pressed="true"]{background:#102b32;color:#eef4f2;box-shadow:inset 0 -2px 0 #54bfd9}
...
.automation-grid[data-view="atlas"]{grid-template-columns:repeat(auto-fill,minmax(270px,1fr));gap:10px}
.automation-atlas-item{display:grid;grid-template-columns:76px minmax(0,1fr);min-height:104px;border:1px solid #243239;background:#10171b;color:#eef4f2;box-shadow:none}
.automation-atlas-item:hover{border-color:#54bfd9}.automation-atlas-visual{display:grid;place-items:center;border-right:1px solid #243239;background:#0c1114}.automation-atlas-visual .automation-icon{flex:none}
.automation-atlas-copy{min-width:0;padding:9px 10px}.automation-atlas-title{display:flex;align-items:flex-start;justify-content:space-between;gap:7px}.automation-atlas-title b{font:700 12px/1.25 ui-monospace,SFMono-Regular,Consolas,monospace;overflow-wrap:anywhere}.automation-atlas-rule{flex:0 0 auto;border:1px solid #3c4d55;border-radius:0;background:#172126;color:#eef4f2;padding:4px 6px;cursor:pointer;font:700 8px/1 ui-monospace,SFMono-Regular,Consolas,monospace}.automation-atlas-rule:hover{border-color:#54bfd9}
.automation-atlas-id{display:block;margin:3px 0 6px;color:#9aabb0;font:10px/1.2 ui-monospace,SFMono-Regular,Consolas,monospace;overflow-wrap:anywhere}.automation-atlas-meta{color:#9aabb0;font:9px/1.45 ui-monospace,SFMono-Regular,Consolas,monospace;overflow-wrap:anywhere}.automation-atlas-meta strong{color:#eef4f2;font-weight:700}.automation-atlas-perms{display:flex;flex-wrap:wrap;gap:3px;margin-top:7px}.automation-atlas-perms .automation-perm{font-size:8px;padding:2px 4px;border-radius:0}
...
@media(max-width:760px){.al-panel{padding:5px}.automation-viewbar{align-items:stretch;flex-direction:column}.automation-viewbar>div:first-child{align-items:flex-start;flex-direction:column;gap:3px}.automation-view-toggle{width:max-content}.event{border-left-width:7px}.event .sev{min-width:70px;padding:6px 7px}.automation-toolbar{grid-template-columns:1fr}.automation-policy{align-items:stretch}.automation-policy label{justify-content:space-between;width:100%}.automation-grid{grid-template-columns:1fr}}
`;
