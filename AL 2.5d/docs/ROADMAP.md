...
- [x] first-party entity animation-state baseline: idle/walk/attack/cast/hit/death/respawn
- [ ] authored frame-by-frame character/NPC/monster animation sheets
...
- [x] death/respawn entity animation baseline from authoritative HP transitions
...
- [x] accept invite/request controls from original game_chats ids + original runner functions
- [x] kick-member control delegated to original kick_party_member; server remains authoritative
- [ ] party leadership controls and remaining party-status edge cases
...
- [x] party/PM channel baseline from original chat DOM plus unread state
- [x] chat sending through original say / party_say / private_say functions only
- [ ] richer chat UX: channel persistence, mentions and notification preferences
...
- [x] rich item tooltip/details baseline from immutable G.items definitions + instance bonus stat
- [ ] advanced item actions and transactional UX
