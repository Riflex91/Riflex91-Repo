...
- [x] loot/chest baseline: immutable chest mirror, first-party chest art and original open_chest(id) interaction
- [ ] richer loot reveal/open animations and reward presentation
