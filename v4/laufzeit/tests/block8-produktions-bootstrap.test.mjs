...
function remoteMeldung(zeit = 10_000) {
...
test('Block-8 Produktions-Bootstrap installiert Live-Smoke auf derselben zentralen Steuerung und ueberschreibt keine Freigabestufen', () => {
  const u = spiel();
  const b = bootstrap(u);
