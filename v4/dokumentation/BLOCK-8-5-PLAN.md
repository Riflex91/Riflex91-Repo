...
Fuer genau diese naechste Stufe ist nun ausserdem `block8-5-schatten-paket.js` als source-locked Copy/Paste-Paket vorbereitet. Es laedt den immutable Candidate gesperrt, ruft `V4ProduktionsLaufzeit.starte()` nicht auf und gibt den Schatten-Knopf erst nach einem erneuten Null-Heartbeat-Preflight frei.
