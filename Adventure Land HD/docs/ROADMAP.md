...
- [x] **8× als Projektstandard festgelegt**
- [x] erster aktiver künstlerischer 8×-Pilot: `jubchan_1@8x.png`
- [x] 624×1152 statt 78×144
- [x] exakte 26×36 Logical-Frame-Geometrie bewahrt
- [x] CI-/Manifest-Gate für echte HD-Binärdatei
- [x] Overlay-Materialization-Smoke bleibt Bestandteil der CI
...
8×-Standard unter realen Texture-/Memory-Budgets validieren und reproduzierbaren HD-Pack-Build etablieren.
