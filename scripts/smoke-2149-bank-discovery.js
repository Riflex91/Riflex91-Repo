...
const block=bot.slice(bot.indexOf('2.14.11 Merchant bank warehouse + active discovery'),bot.indexOf("audit('feature_contract','2.14.11"));
...
console.log('2.14.11 Merchant warehouse / discovery / productive-idle smoke OK');
