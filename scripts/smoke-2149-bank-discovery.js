...
const block=bot.slice(bot.indexOf('2.14.13 Merchant bank warehouse + active discovery'),bot.indexOf("audit('feature_contract','2.14.13"));
...
console.log('2.14.13 Merchant warehouse / discovery / productive-idle smoke OK');
