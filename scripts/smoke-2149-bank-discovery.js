...
const block=bot.slice(bot.indexOf('2.14.12 Merchant bank warehouse + active discovery'),bot.indexOf("audit('feature_contract','2.14.12"));
...
console.log('2.14.12 Merchant warehouse / discovery / productive-idle smoke OK');
