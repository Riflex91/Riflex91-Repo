...
assert.ok(!bot.slice(bot.indexOf('2.14.9 Merchant bank warehouse + active discovery'),bot.indexOf("audit('feature_contract','2.14.12")).includes("interact('the_lever')"),'disruptive lever probing must remain disabled');
console.log('2.14.12 discovery safety / full static catalog smoke OK');
