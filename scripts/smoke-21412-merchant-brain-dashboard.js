...
assert(bot.includes("var VERSION = '"+version.version+"';"));
...
assert(dash.includes('AiO Bot Dashboard '+version.version));
...
assert(worker.includes('AiO Bot Dashboard '+version.version));
