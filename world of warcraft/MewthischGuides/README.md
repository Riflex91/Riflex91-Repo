# Mewthisch Guides v0.11.6 — Runtime-Routing, Config und Weltkarten-Ziel

v0.11.6 härtet den produktiven Forever-Betrieb: Questfortschritt wird über
...
Zusätzlich zum Recorder-Seed lädt v0.11.6 die strukturierten Fakten aus allen
...
Nach diesem v0.11.6-Build folgt die gezielte Ingame-Verifikation anhand echter
...
v0.11.6 verwendet deshalb einen bekannten unterstützten `INVTYPE_*` als
