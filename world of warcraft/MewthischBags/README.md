...
- Gold, Silber und Kupfer werden oben mittig mit den Blizzard-eigenen Währungssymbolen angezeigt.
...
- Hauptfenster ist verschiebbar und merkt sich seine Position über MewthischBagsDB.
- /mbags oder /mewthischbags öffnet/schließt das Fenster.
- /mbags reset setzt die Fensterposition zurück.
...
v0.1 ist die erste lauffähige Implementierung. Vor einer Freigabe müssen die Runtime-Tests aus TESTPLAN.md auf WoW Forever durchgeführt werden, insbesondere das Verhalten der Blizzard-Taschenhooks und der Taschenwechsel.
